...
function exibeJogadoresNaTela(jogadores) {
  ...
  for (var i = 0; i < jogadores.length; i++) {
    ...
    elemento +=
      ...
      i +
      ")''>Adicionar Vitória</button></td>";
    elemento +=
      "<td><button onClick='adicionarEmpate(" +
      i +
      ")'>Adicionar Empate</button></td>";
    elemento +=
      "<td><button onClick='adicionarDerrota(" +
      i +
      ")'>Adcionar Derrota</button></td>";
  }
...
function incluirJogadores(nome) {
  return (jogador = {
    nome: nome,
    vitorias: 0,
    empates: 0,
...
function adicionarJogador() {
  ...
  jogadores.push(incluirJogadores(nome));
  exibeJogadoresNaTela(jogadores);
}

function zerarPontuações(i) {
  for (var i = 0; i < jogadores.length; i++) {
